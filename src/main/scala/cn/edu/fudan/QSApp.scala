...
object QSApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val chain_0_1 = makechain(pre2_0, sizeofhash, 1, 3, numpar, 28.9289770852, 53643182.9708513245)
    val chain_0_2 = makechain(pre2_0, sizeofhash, 2, 3, numpar, 1.0358051065, 68529410.1228341758)
    ...
    val filpos_0_1 = set_0_1.filter(x => x._2 == 1).coalesce(60,true)
    val filneg_0_1 = set_0_1.filter(x => x._2 == -1)
    val filpos_0_2 = set_0_2.filter(x => x._2 == 1).coalesce(60,true)
